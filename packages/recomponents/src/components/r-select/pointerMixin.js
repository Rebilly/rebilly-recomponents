export default {
    ...
    methods: {
        ...
        groupHighlight (index, selectedGroup) {
            if (!this.groupSelect) {
                return ['r-select__option--group', 'r-select__option--disabled']
            }
            ...
            return group && !this.wholeGroupDisabled(group) ? [
                'r-select__option--group',
                { 'r-select__option--highlight': index === this.pointer && this.showPointer },
                { 'r-select__option--group-selected': this.wholeGroupSelected(group) }
            ] : 'r-select__option--disabled'
        },
